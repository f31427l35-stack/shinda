  ...
  try {
    ...
    if (adjustedDepth === 6 && mainChoice === "2") {
      if (lastChoice === "1") {
        ...
        if (loanProduct === "1") seededFee = Math.floor(50 + phoneSeed % 11);
        if (loanProduct === "2") seededFee = Math.floor(60 + phoneSeed % 11);
        if (loanProduct === "3") seededFee = Math.floor(70 + phoneSeed % 11);
