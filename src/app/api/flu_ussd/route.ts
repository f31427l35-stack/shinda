  ...
  try {
    ...
    if (adjustedDepth === 3) {
      ...
      if (mainChoice === "3") {
        ...
        const seededRepayment = Math.floor(300 + phoneSeed % 301); // Generates a reproducible random amount between 50 and 70
    ...
    if (adjustedDepth === 4) {
      ...
      if (mainChoice === "1") {
        if (lastChoice === "1") {
          const seededFee = Math.floor(300 + (parseFloat(phone.slice(-3)) || 5) % 301); // 60-70 range
    ...
    if (adjustedDepth === 5) {
      ...
      if (mainChoice === "1") {
        if (lastChoice === "1") {
          const seededFee = Math.floor(300 + (parseFloat(phone.slice(-3)) || 5) % 301);
          const appUrl = process.env.APP_URL || "https://vercel.app";
          const callbackUrl = `${appUrl}/api/payment-callback`;
      ...
      if (mainChoice === "2") {
        if (lastChoice === "1") {
          ...
          if (loanProduct === "1") seededFee = Math.floor(300 + phoneSeed % 401); // Salary: 40-50
          if (loanProduct === "2") seededFee = Math.floor(300 + phoneSeed % 301); // Biashara: 50-60
          if (loanProduct === "3") seededFee = Math.floor(300 + phoneSeed % 301); // Emergency: 60-70
    ...
    if (adjustedDepth === 6 && mainChoice === "2") {
      if (lastChoice === "1") {
        const loanProduct = isExtensionDial ? segments[1] : segments[2];
        const phoneSeed = (parseFloat(phone.slice(-3)) || 5);
        let seededFee = Math.floor(300 + phoneSeed % 301);
        
        if (loanProduct === "1") seededFee = Math.floor(300 + phoneSeed % 301);
        if (loanProduct === "2") seededFee = Math.floor(300 + phoneSeed % 301);
        if (loanProduct === "3") seededFee = Math.floor(300 + phoneSeed % 301);
