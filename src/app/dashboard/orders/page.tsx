  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-white text-2xl font-semibold">Orders</h2>
        <a
            ...
            {loading ? (
              ...
              orders.map((o) => (
                <tr key={o.id} className="border-b border-neutral-800/60 text-white hover:bg-neutral-800/40">
                  <td className="py-3 px-5">{o.phone_number}</td>
                  <td className="py-3 px-5 text-neutral-300">
                    {o.package_size}{o.quantity > 1 ? ` ×${o.quantity}` : ""}
                  </td>
                  <td className="py-3 px-5 font-medium">KES {o.total_amount.toLocaleString()}</td>
